...
export default function CreateTest() {
  ...
  const uploadCsvMutation = useMutation({
    ...
    onSuccess: (result) => {
      ...
      // Refresh the page or reload questions
  ...
  const handleCsvUpload = (file: File) => {
    if (!generatedTestId) {
      toast({
        title: "Create Test First",
        description: "Please create a test before uploading CSV questions.",
        variant: "destructive",
      });
      return;
    }
    uploadCsvMutation.mutate({ testId: generatedTestId, file });
  };
